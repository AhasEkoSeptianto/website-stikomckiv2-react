...
export const N_POSTDosen = async ( body: I_POSTDosen ) => {
    return await POST(APIADmIN.DOSEN.ADD_DOSEN, body)
}

export const N_PUTDosen = async ( body: I_POSTDosen, unique_id: any ) => {
    return await PUT(APIADmIN.DOSEN.UPDATE_DOSEN, {unique_id: unique_id}, body)
}

export const N_DELETEDosen = async ( unique_id: any ) => {
