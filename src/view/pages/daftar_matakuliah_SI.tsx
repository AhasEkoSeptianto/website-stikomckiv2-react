            ...
            <Grid item sm={8}>
              <Paper className={"p-10"} variant="outlined" square>
                ...
                <div className={s.paperContent}>
                  <h2 className={s.contentheader}>Daftar matakuliah SI</h2>
                    ...
                    <Container>
                      ...
                      >
                        ...
                        <Table aria-label="simple table">
                          <TableHead>
                            <TableRow>
                              <TableCell className={s.table_font}>No</TableCell>
                              <TableCell
                                align="center"
                                className={s.table_font}
                              >
                                Nama Dosen Pengajar
                              </TableCell>
                              <TableCell
                          ...
                          <TableBody>
                            {Data.map((daftar_matakuliah, i) => (
                              <TableRow key={i}>
                                <TableCell className={s.table_font}>
                                ...
                                <TableCell
                                  ...
                                  className={s.table_font}
                                >
                                  {daftar_matakuliah.data.map((data, i) => (
                                    <TableRow key={i}>
                                      <TableCell
                                        align="left"
                                        className={`${s.table_font} whitespace-nowrap`}
                                      >
